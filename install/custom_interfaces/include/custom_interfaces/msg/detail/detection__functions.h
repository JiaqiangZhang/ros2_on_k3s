...
#ifndef CUSTOM_INTERFACES__MSG__DETAIL__DETECTION__FUNCTIONS_H_
#define CUSTOM_INTERFACES__MSG__DETAIL__DETECTION__FUNCTIONS_H_
 ...
 * calls
 * custom_interfaces__msg__Detection__init().
...
/**
 * It calls
 * custom_interfaces__msg__Detection__fini()
 ...
 * custom_interfaces__msg__Detection__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interfaces__msg__Detection__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__DETECTION__FUNCTIONS_H_
