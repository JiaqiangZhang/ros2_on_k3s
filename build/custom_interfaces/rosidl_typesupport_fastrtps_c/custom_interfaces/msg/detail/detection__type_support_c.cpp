...
#include "custom_interfaces/msg/detail/detection__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // bound, name
#include "rosidl_runtime_c/string_functions.h"  // bound, name

// forward declare type support functions


using _Detection__ros_msg_type = custom_interfaces__msg__Detection;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: bound
  {
    const rosidl_runtime_c__String * str = &ros_message->bound;
    if (str->capacity == 0 || str->capacity <= str->size) {
      fprintf(stderr, "string capacity not greater than size\n");
      return false;
    }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: bound
  {
    std::string tmp;
    cdr >> tmp;
    if (!ros_message->bound.data) {
      rosidl_runtime_c__String__init(&ros_message->bound);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->bound,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'bound'\n");
      return false;
    }
  }
...
static uint32_t _Detection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__Detection(
...
{
  return max_serialized_size_custom_interfaces__msg__Detection(
    full_bounded, 0);
}
